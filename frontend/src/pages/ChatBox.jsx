...
import { addMessage, fetchMessages, resetMessages, fetchSuggestions, clearSuggestions } from '../features/messages/messagesSlice'
import toast from 'react-hot-toast'

const ChatBox = () => {

  const {messages, suggestions, loadingSuggestions} = useSelector((state)=>state.messages)
  ...
  const generateSuggestions = async () => {
    ...
    try {
      ...
      const result = await dispatch(fetchSuggestions({ token, messages: [lastMessage] }))
